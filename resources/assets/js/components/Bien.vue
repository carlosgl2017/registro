                ...
                <div class="card-body">
                    ...
                    <div class="col-12 flex-flow text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            <h2 id="heading">
                                Registra bienes (muebles y enseres)
                            </h2>
                            <p>Registrar</p>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Añadir
                                    nuevo bien
                                    <button
                                        type="button"
