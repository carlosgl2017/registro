                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="invalid feedback">
                      <span class="text-danger" v-if="!$v.monto.required"
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      name="plazo"
                      class="form-control"
                      v-model.trim="$v.plazo_meses.$model"
                      :class="{
                        'is-invalid': $v.plazo_meses.$error,
                        'is-valid': !$v.plazo_meses.$invalid,
                      }"
                    />
                    <div class="valid-feedback">Correcto!</div>
                    <div class="invalid feedback">
                      <span class="text-danger" v-if="!$v.plazo_meses.required"
                        >Este campo es obligatorio</span
                      >
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    >
                    <select class="form-control" v-model="id_tipo_credito">
                      <option value="0" disabled>Seleccione</option>
                      <option
                        v-for="tipo_credito in arrayTipoCredito"
                        :key="tipo_credito.id_tipo_credito"
                        :value="tipo_credito.id_tipo_credito"
                        v-text="tipo_credito.tipo_credito"
                      ></option>
                    </select>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control" v-model="id_destino">
                      ...
                      <!-- CONSUMO  -->
                      <option v-if="this.id_tipo_credito == 1" value="1">
                        COMPRA DE BIENES MUEBLES
                      </option>
                      <option v-if="this.id_tipo_credito == 1" value="2">
                        LIBRE DISPONIBILIDAD
                      </option>

                      <!-- CONSUMO  -->
                      <option v-if="this.id_tipo_credito == 2" value="3">
                        CAPITAL DE INVERSIONES
                      </option>
                      <option v-if="this.id_tipo_credito == 2" value="4">
                        CAPITAL DE OPERACIONES
                      </option>

                      <!-- CONSUMO  -->
                      <option v-if="this.id_tipo_credito == 3" value="5">
                        CONSTRUCCIÓN DE VIVIENDA
                      </option>
                      <option v-if="this.id_tipo_credito == 3" value="6">
                        ADQUISICIÓN DE TERRENO
                      </option>
                      <option v-if="this.id_tipo_credito == 3" value="7">
                        REFACCIÓN , REMODELACIÓN, AMPLIACIÓN, MEJORAMIENTO DE
                        VIVIENDA
                      </option>
                      <option v-if="this.id_tipo_credito == 3" value="8">
                        COMPRA DE VIVIENDA
                      </option>
...
export default {
  ...
  methods: {
    actualizar() {
      ...
      axios
        ...
        .then(function (response) {
          ...
          me.monto=res.credito[0].monto;
          me.plazo_meses=res.credito[0].plazo_meses;
          me.id_tipo_credito=res.credito[0].id_tipo_credito;
          me.id_destino=res.credito[0].id_destino;
         // me.id_tipo_credito=this.arrayTipoCredito[0].id_tipo_credito;
        })
    ...
    validarCredito() {
      ...
      if (this.monto == null)
        this.errorMostrarMsjCredito.push("El monto no puede estar vacío.");
      if (this.plazo_meses == null)
        this.errorMostrarMsjCredito.push("El plazo no puede estar vacío.");
