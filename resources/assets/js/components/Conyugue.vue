                ...
                <div class="card-body">
                    ...
                    <div class="col-12 flex-flow text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            <h2 id="heading">Datos del conyugue</h2>
                            <p>Completa los datos de tu conyugue</p>
                            <!-- progressbar -->
                            <ul id="progressbar">
        ...
        validarPersona() {
            ...
            if (!this.id_extension)
                this.errorMostrarMsjPersona.push(
                    "La extensión de ci es obligatoria."
                );
            if (!this.nombre)
                this.errorMostrarMsjPersona.push(
