...
class NacionalidadController extends Controller
{
    ...
    public function selectNacionalidad(Request $request){
        if (!$request->ajax()) return redirect('/');
        $nacionalidades = Nacionalidad::where('condicion','=','1')
        ->select('id_nacionalidad','nacionalidad')->orderBy('nacionalidad', 'asc')->get();
